...
public:
	...
	void DF_prepareAttribute();

	void DF_prepareAttribute2();

	void VF_prepareAttribute();

	void VF_constantVolumeSolver();

	void DF_constantDensitySolver();

	void DF_divergenceFreeSolver();

	void VF_divergenceFreeSolver();
...
protected:
	...
	//see 11
	void computeForceFromSolidToCandidate(CandidatePart& ca, const BoundPart& bb, const real_t& dis,const real_t& r_alpha);

	//see 11
	void computeForceFromCandidateToFluid(FluidPart& fa, const CandidatePart& cb, const real_t& dis,
		const real_t& frho0, const real_t& r_alpha);

	//see 11
	void computeForceFromCandidateToFluidExceptPressure(FluidPart& fa, const CandidatePart& cb, const real_t& dis,
		const real_t& frho0, const real_t& r_alpha);

	//see 11
	void computeForceFromFluidToCandidate(CandidatePart& ca, const FluidPart& fb, const real_t& dis,
		const real_t& frho0, const real_t& fm0, const real_t& r_alpha);

	//see 11
	void computeForceFromCandidateToCandidate(CandidatePart& cp1, CandidatePart& cp2, const real_t& dis);

	//see 12
	real_t temperatureCorrtedDensity(real_t temperature);
